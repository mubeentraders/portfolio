    ...
    <div class="2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
      ...
      <div class="container mx-auto pt-16">
        ...
        <div class="xl:py-16 lg:py-16 md:py-16 sm:py-16 px-15 flex flex-wrap">
          ...
          >
            <img src="/jolta_electric.png" alt="jolta electric" />
          </div>
          <div
          ...
          >
            <img src="/spirit_school.png" alt="spirit school" />
          </div>
          <div
          ...
          >
            <img src="/punjab_university.png" alt="punjab university" />
          </div>
          <div
            class="w-6/12 xl:w-1/4 lg:w-1/4 md:w-1/4 flex justify-center xl:border-r lg:border-r border-gray-200 xl:pt-10 items-center"
          >
            <img src="/aabroo.png" alt="aabroo educational welfare org" />
          </div>
          ...
          >
            <img src="/lhr_general_hospital.png" alt="lahore general hospital" />
          </div>
        </div>
      </div>
    </div>
