  ...
  <div class="bg-gray-100 pb-16">
    ...
    <div class="w-full bg-gray-100 px-10 pt-10">
      <div class="container mx-auto">
        <div
          class="lg:flex md:flex sm:flex items-center space-x-4 xl:justify-center md:justify-around sm:justify-around lg:justify-around"
        >
          <div
          ...
          >
            <div class="h-300 rounded overflow-hidden shadow-md bg-white">
              <div class="absolute -mt-20 w-full flex justify-center">
                <div class="h-32 w-32">
                  <img :src="member.profile" alt="" class="rounded-full object-cover h-full w-full shadow-md" />
                </div>
              </div>
              <div class="px-6 mt-16">
                <div class="font-bold text-3xl text-center pb-1">{{ member.name }}</div>
                <p class="text-gray-800 text-sm text-center">{{ member.role }}</p>
          ...
          <!-- <div class="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5">
            <div class="h-300 rounded overflow-hidden shadow-md bg-white">
              ...
              <div class="px-6 mt-16">
                ...
                <p class="text-center text-gray-600 text-base pt-3 font-normal">
                  The emphasis on innovation and technology in our companies has resulted in a few of them establishing
          ...
          <div class="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5">
            <div class="h-300 rounded overflow-hidden shadow-md bg-white">
              ...
              <div class="px-6 mt-16">
                <div class="font-bold text-3xl text-center pb-1">Johnson Stone</div>
          ...
          <div class="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5">
            <div class="rounded overflow-hidden shadow-md bg-white">
              ...
              <div class="px-6 mt-16">
                <div class="font-bold text-3xl text-center pb-1">Dean Jones</div>
                <p class="text-gray-800 text-sm text-center">Principal Software Engineer</p>
                <p class="text-center text-gray-600 text-base pt-3 font-normal">
                  An avid open-source developer who loves to be creative and inventive. I have 20 years of experience in
                  the field.
                </p>
                <div class="w-full flex justify-center pt-5 pb-5">
                  <a href="javascript:void(0)" class="mx-5">
          ...
          <div class="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5">
            <div class="rounded overflow-hidden shadow-md bg-white">
              ...
              <div class="px-6 mt-16">
                <div class="font-bold text-3xl text-center pb-1">Rachel Adams</div>
                <p class="text-gray-800 text-sm text-center">Product Design Head</p>
                <p class="text-center text-gray-600 text-base pt-3 font-normal">
                  Product designer with interests in immersive computing and XR, political ventures, and emerging
          ...
          <div class="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5">
            <div class="rounded overflow-hidden shadow-md bg-white">
              ...
              <div class="px-6 mt-16">
                <div class="font-bold text-3xl text-center pb-1">Charles Keith</div>
                <p class="text-gray-800 text-sm text-center">UX Designer</p>
                <p class="text-center text-gray-600 text-base pt-3 font-normal">
                  A UX designer is the voice of the customer. Our job is to look beyond the business goals. We don't
...
export default {
  ...
  data() {
    return {
      team: [
        {
          profile: 'https://cdn.tuk.dev/assets/photo-1564061170517-d3907caa96ea.jfif',
          name: 'Andres Berlin',
          role: 'Chief Executive Officer',
          job: "The CEO's role in raising a company's corporate IQ is to establish an atmosphere that promotes knowledge sharing and collaboration."
        },
        {
          profile: 'https://cdn.tuk.dev/assets/photo-1530577197743-7adf14294584.jfif',
          name: 'Silene Tokyo',
          role: 'Product Design Head',
          job: 'The emphasis on innovation and technology in our companies has resulted in a few of them establishing global benchmarks in product design.'
        }
      ]
    };
  }
