...
onMounted(() => {
  console.log("Mode", import.meta.env.VITE_EMAILJS_PUBLIC_KEY)
})
const form = ref(null)
function sendEmail() {
  emailjs.sendForm(process.env.EMAILJS_SERVICE_ID, process.env.EMAILJS_TEMPLATE_ID, this.$refs.form, process.env.EMAILJS_YOUR_PUBLIC_KEY)
    .then((result) => {
