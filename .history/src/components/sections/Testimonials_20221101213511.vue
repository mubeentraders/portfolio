  ...
  <div id="testimonials" class="bg-white">
    <div class="lg:px-20 md:px-6 px-4 py-12">
      <div class="flex flex-col items-center justify-center">
        ...
        <p class="text-base leading-6 mt-4 text-center text-gray-600 2xl:w-2/5 sm:w-96">
          Don't just trust what we say, hear what our clients have to say about us.
        </p>
      </div>
      <div class="w-full lg:flex items-center gap-6 mt-10">
        <div class="lg:w-1/2">
          <div class="bg-white border rounded-md border-gray-200 relative sm:p-10 p-6">
            ...
            <p class="text-base leading-6 text-gray-600 mt-4">
              When our IT equpiment related enquiries need an expert opinion or approval, I know I can rely on Mubeen Traders. Thank you for all
              your help, I will be recommending you to everyone
            </p>
          ...
          <div class="flex items-center mt-7">
            ...
            <div class="flex flex-col items-start ml-4">
              <p class="text-base font-semibold leading-4 text-gray-800">Ali Faraz</p>
              <p class="text-base leading-4 mt-2 text-center text-gray-600">DCP Ministry Of Foreign Affairs</p>
            </div>
          </div>
        </div>
        <div class="lg:w-1/2 lg:mt-0 mt-16">
          <div class="bg-white border rounded-md border-gray-200 relative sm:p-10 p-6">
            ...
            <p class="text-base leading-6 text-gray-600 mt-4">
              I had an emergency and wanted to deploy a new CCTV network department wise and luckily I found Mubeen Traders.
              They didn't just deliver the work on time but also was very cost efficient. Highly recommended.
            </p>
            <div class="absolute bottom-0 -mb-4 ml-10">
              <svg width="23" height="22" viewBox="0 0 23 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="1" width="20" height="21" fill="white" />
          ...
          <div class="flex items-center mt-7">
            ...
            <div class="flex flex-col items-start ml-4">
              <p class="text-base font-semibold leading-4 text-gray-800">Rizwan Haider</p>
              <p class="text-base leading-4 mt-2 text-center text-gray-600">Punjab University Lahore</p>
            </div>
          </div>
        </div>
      </div>
...
<script setup>
import { UserCircleIcon } from '@headlessui/vue/solid'
</script>