    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6">
      <div class="flex justify-center md:justify-between items-center border-b-2 border-gray-100 py-2 md:justify-start md:space-x-10">
        ...
        <div class="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
          ...
          <a
            href="#contact"
            class="ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 rounded-md shadow-sm text-base font-medium text-white bg-gradient-to-r from-indigo-600 to-cyan-600 hover:bg-indigo-700"
          >
            Get A Quote
          </a>
        </div>
